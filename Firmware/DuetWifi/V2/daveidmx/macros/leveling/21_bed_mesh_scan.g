...
;; If instead we "G29" with the opposite probe configuration vs. the "homezi",
...
M98 P"homezi.g"                 ; switch the Z coordinate space to use inductive Z0
M98 P"zprobe_use_islow.g"       ; switch back to slow probing to match the homezi call
...
M98 P"homezm.g"                 ; re-home using the mechanical switch
