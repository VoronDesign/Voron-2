...
static void lcd_main_menu() {
  ...
  if (movesplanned() || IS_SD_PRINTING) {
    ...
    #endif
    MENU_ITEM(function, MSG_DROP_BED, lcd_dropbed);
  }
...
static void lcd_control_temperature_menu() {
  ...
  //
    ...
    #define _PID_MENU_ITEMS(ELABEL, eindex) \
    ...
    #if ENABLED(PID_PARAMS_PER_EXTRUDER) && HEATER_BLOCKS > 1
      ...
      PID_MENU_ITEMS(MSG_E2, 1);
        ...
        #endif //EXTRUDERS > 3
      #endif //EXTRUDERS > 2
    #else //!PID_PARAMS_PER_EXTRUDER || HEATER_BLOCKS == 1
      PID_MENU_ITEMS("", 0);
    #endif //!PID_PARAMS_PER_EXTRUDER || HEATER_BLOCKS == 1
...
static void lcd_control_motion_menu() {
  ...
  #endif
  MENU_ITEM(function, MSG_REHOME_Z, lcd_autohome_z);
